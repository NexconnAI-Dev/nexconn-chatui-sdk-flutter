...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new ai.nexconn.ai_nexconn_chatui_plugin.AiNexconnChatUIPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin ai_nexconn_chatui_plugin, ai.nexconn.ai_nexconn_chatui_plugin.AiNexconnChatUIPlugin", e);
    }
    try {
